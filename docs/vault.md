...
The AIStor Free license is **not** in KV and is **not** written by Vault Agent. Place `.nexusflow/minio.license` on each host (same path as local). See [docker/minio/README.md](../docker/minio/README.md).
